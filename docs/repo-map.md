...
| --- | --- | --- |
| "How do I get one successful result?" | `../README.md` | the flagship front door stays there |
| "What does the first proof actually prove?" | `./archive-shell-proof.md` | this is the proof explanation page |
| "Where are transcripts, reports, and evidence rendered?" | `src/output/` | this is the output shell layer |
| "Where are connector boundaries defined?" | `src/connectors/` | this is the source adapter layer |
| "Where does archive and governance logic live?" | `src/core/` | this is the contract and decision layer |
| "Where is the repo-owned integration lane?" | `docs/integrations/` | this is the integration pack surface |
| "Where are the truth boundaries and upstream reading lists?" | `docs/reference/` | this is the constraint shelf |
...
<section class="ae-section">
  <div class="ae-split">
    ...
    <article class="ae-split-card">
      ...
      <ul class="ae-bullet-list">
        <li>go back to `README.md` for first success</li>
        <li>open `archive-shell-proof.md` for proof interpretation</li>
        <li>open `docs/distribution-packet-ledger.md` only when lane truth matters</li>
      </ul>
    </article>
  </div>
</section>
